...
import 'package:crud_perpustakaan1/insert.dart'; // Mengimport halaman untuk menambah buku.
...
class BookListPage extends StatefulWidget {
  ...
  @override
  _BookListPageState createState() =>
      _BookListPageState(); // Membuat state untuk widget ini.
}
...
class _BookListPageState extends State<BookListPage> {
  ...
  void initState() {
    super
        .initState(); // Memanggil implementasi initState bawaan StatefulWidget.
  ...
  Future<void> fetchBooks() async {
    ...
    setState(() {
      buku = List<Map<String, dynamic>>.from(
          response); // Menyimpan hasil query ke dalam list buku.
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            const Text('Daftar Buku'), // Menampilkan judul aplikasi di app bar.
        actions: [
          // Tombol untuk me-refresh data buku.
          IconButton(
            icon: const Icon(Icons.refresh), // Ikon refresh.
            onPressed:
                fetchBooks, // Tombol untuk refresh, memanggil fetchBooks.
          ),
        ],
      ),
      ...
      body: buku.isEmpty
          ? const Center(
              child:
                  CircularProgressIndicator()) // Menampilkan indikator loading saat data belum ada.
          : ListView.builder(
              // Menggunakan ListView.builder untuk menampilkan daftar buku.
              itemCount: buku
                  .length, // Menentukan jumlah item berdasarkan panjang data buku.
              itemBuilder: (context, index) {
                final book =
                    buku[index]; // Mengambil data buku berdasarkan index.
                return ListTile(
                  title: Text(
                    book['title'] ??
                        'No Title', // Menampilkan judul buku atau 'No Title' jika kosong.
                  ...
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment
                        .start, // Menyusun elemen subtitle secara vertikal.
                    children: [
                      Text(
                        book['author'] ??
                            'No Author', // Menampilkan penulis atau 'No Author' jika kosong.
                        style: TextStyle(
                      ...
                      Text(
                        book['description'] ??
                            'No Description', // Menampilkan deskripsi atau 'No Description' jika kosong.
                        style: TextStyle(
                          fontSize: 12.0,
                        ),
                      ),
                  ...
                  trailing: Row(
                    mainAxisSize: MainAxisSize
                        .min, // Menyusun tombol edit dan delete secara horizontal.
                    children: [
                        ...
                        onPressed: () {
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title:
                                    const Text('Delete Book'), // Judul dialog.
                                content: const Text(
                                    'Are you sure you want to delete this book?'), // Pesan konfirmasi penghapusan.
                                actions: [
                                  // Tombol untuk membatalkan penghapusan.
                                  TextButton(
                                    onPressed: () {
                                      Navigator.of(context)
                                          .pop(); // Menutup dialog jika tombol 'Cancel' ditekan.
                                    },
